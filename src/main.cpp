...
unsigned int nStakeTargetSpacing = 190;			// 120 sec block spacing

int64 nChainStartTime = 1426460879;
...
const string strMessageMagic = "BaseBallCardCoin Signed Message:\n";
...
{
	int64 nSubsidy = 1.9 * COIN;

	if(nHeight == 1)
	{
		nSubsidy = 250000 * COIN;	// 250K coins Premine
		return nSubsidy + nFees;
	}
    if (nHeight <= 2880) {
        nSubsidy = 190 * COIN; // 190 Coins Per Block For 72 Hours
        return nSubsidy + nFees;   
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BaseBallCardCoin
    bool fStrictPayToScriptHash = true; // Always active in BaseBallCardCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BaseBallCardCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "March 14, 2015. Baseball is a game about numbers. March 14th is for stat geeks and number nerds. 1426460879";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1426460879;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2042099;
        ...
        assert(block.hashMerkleRoot == uint256("6590050350f3c1c2e6a7d7fa15d8a9a653651fab9969212ceef85c51ddc91124"));
